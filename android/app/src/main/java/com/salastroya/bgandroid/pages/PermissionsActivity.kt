...
open class BeaconScanPermissionsActivity : PermissionsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val message = intent.getStringExtra("message")
            ?: "In order to scan for beacons, this app requires the following permissions from the operating system.  Please tap each button to grant each required permission."
        ...
        continueButton.setOnClickListener {
            MainStore.activeSearch.value = true
            this.finish()
        }
